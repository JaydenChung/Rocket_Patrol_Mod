class Play extends Phaser.Scene {
    ...
    create(){
        ...
        this.smallShip = new SmallerSpaceship(this, game.config.width + borderUISize * 4, borderUISize * 11, 'smallerspaceship', 0, 50).setOrigin(0, 0);
        ...
        this.input.on('pointerdown', function (pointer) {
            if (pointer.leftButtonDown()) {
                // Call a function when the left mouse button is clicked
    ...
    update(){
        ...
        if (this.p1Rocket.y <= borderUISize * 3.1 + borderPadding) {
            this.clock.delay -= 2500
        }
    }
